...
-----------------------------------------------------------------------------
--local math = require('math') -- Commented out due to raising errors in Rainmeter's Lua environment (Kapiainen)
--local string = require("string") -- Commented out due to raising errors in Rainmeter's Lua environment (Kapiainen)
--local table = require("table") -- Commented out due to raising errors in Rainmeter's Lua environment (Kapiainen)
